...
public class vistaJT {
    ...
    public static compra BuscarPorCodigo(String codigo, ArrayList<compra> lista){
        for(compra c : lista){
    ...
    public static ArrayList<compra> BuscarPorNombre(String nombre, ArrayList<compra> lista){
